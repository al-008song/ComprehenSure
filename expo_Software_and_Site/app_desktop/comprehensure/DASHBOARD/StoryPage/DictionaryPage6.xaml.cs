...
public partial class DictionaryPage6 : ContentPage
{
    private Button? _activeButton;
    private CancellationTokenSource? _cts;
    private Dictionary<string, Border> _wordCards = new();

    public DictionaryPage6()
    {
        InitializeComponent();
        ...
        {
            { "acknowledging", CardAcknowledging },
            { "breakthrough", CardBreakthrough },
            { "delicate", CardDelicate },
            { "disorienting", CardDisorienting },
            { "eliminate", CardEliminate },
            { "fascination", CardFascination },
            { "hesitation", CardHesitation },
            { "investigations", CardInvestigations },
            { "precision", CardPrecision },
            { "predictable", CardPredictable },
            { "psychological", CardPsychological },
            { "stability", CardStability },
            { "suppress", CardSuppress },
            { "suspended", CardSuspended },
            { "translucent", CardTranslucent },
            { "unsettled", CardUnsettled },
