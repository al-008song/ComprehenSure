...
{
    public partial class QuizPage8ViewModel : ObservableObject
    {
        ...
        {
            using var stream = await FileSystem.OpenAppPackageFileAsync("quiz8data.json");
        ...
        public async Task SaveQuizResults()
        {
            ...
            await QuizFunc.SaveQuizProgressAsync(storyNumber: 8, quizScore: Score);
        }
    }
}
