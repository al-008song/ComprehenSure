...
{
    public partial class QuizPage4ViewModel : ObservableObject
    {
        ...
        {
            using var stream = await FileSystem.OpenAppPackageFileAsync("quiz4data.json");
        ...
        public async Task SaveQuizResults()
        {
            ...
            // ── Save calculatedprog4 to StoryPage collection ──────────────
            await QuizFunc.SaveQuizProgressAsync(storyNumber: 4, quizScore: Score);
        }
    }
}
