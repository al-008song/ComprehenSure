...
public partial class DictionaryPage3 : ContentPage
{
    private Button? _activeButton;
    private CancellationTokenSource? _cts;
    private Dictionary<string, Border> _wordCards = new();

    public DictionaryPage3()
    {
        InitializeComponent();
        ...
        _wordCards = new Dictionary<string, Border>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "anticipation", CardAnticipation },
            { "calculations", CardCalculations },
            { "caretaker", CardCaretaker },
            { "chaotic", CardChaotic },
            { "clarity", CardClarity },
            { "consistent", CardConsistent },
            { "constellations", CardConstellations },
            { "disciplined", CardDisciplined },
            { "fascinated", CardFascinated },
            { "gradually", CardGradually },
            { "horizon", CardHorizon },
            { "invisible", CardInvisible },
            { "observation", CardObservation },
            { "observatory", CardObservatory },
            { "precisely", CardPrecisely },
